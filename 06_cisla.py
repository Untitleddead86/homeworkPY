...
for i in cisla:
    ...
    if i < 0: 
        pocet_zapornych += 1 
        print(i, 'cislo je zaporne')
        print(f'Zaporny: {pocet_zapornych}')
        
    else:
        pocet_kladnych += 1
        print(i, 'cislo je kladne')
        print(f'Kladny: {pocet_kladnych}')

   
print('Pocet kladnych ve listu: ', pocet_kladnych)
print('Pocet zapornych ve listu: ', pocet_zapornych)
